...
public class OccasionAdapter extends RecyclerView.Adapter<OccasionAdapter.ViewHolder> {
    ...
    List<OccasionByData>occasionByDataList;
    Context context;

    public OccasionAdapter(List<OccasionByData> occasionByDataList, Context context) {
        this.occasionByDataList = occasionByDataList;
    ...
    public OccasionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.occasion_by_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull OccasionAdapter.ViewHolder holder, int position) {
      final   OccasionByData data = occasionByDataList.get(position);
      ...
      holder.txt_name.setText(data.getName());
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString(AppConstant.ShopStatus,"1");/*shop by occasion*/
                editor.commit();
    ...
    public int getItemCount() {
        return occasionByDataList.size();
    }
